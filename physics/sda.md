...
![image-20250620101956015](./sda/img/image-20250620101956015.png)
...
![image-20250620112528471](./sda/img/image-20250620112528471.png)

其中

![image-20250620112552471](./sda/img/image-20250620112552471.png)



估计量的协方差矩阵的逆

![image-20250620112815552](./sda/img/image-20250620112815552.png)
...
![image-20250620113250656](./sda/img/image-20250620113250656.png)
...
![image-20250620201818110](./sda/img/image-20250620201818110.png)

我们在一个位置测量***一次***温度，那么这一个温度值yi也是满足高斯分布的，在其他位置也干一样的事情：测量一次温度，那么我们会得到多个高斯分布函数（假设每个位置的温度的真值是lambda(x)这个函数）。对于***一个位置***，有一个高斯分布函数，由上一章我们知道，这个函数是***这个位置的似然函数***。那么我们是不是可以用这些函数去求一些最大似然估计量了？

我们直接把他们全部乘起来（如7.1），忽略系数，求对数（如下）

![image-20250620202755329](./sda/img/image-20250620202755329.png)

当然，如果你的各个测量值yi之间不是独立的，用下面的式子

![image-20250620204257845](./sda/img/image-20250620204257845.png)
...
![image-20250621094052720](./sda/img/image-20250621094052720.png)

这里的aj相互独立就可以了

如果把7.6写成矩阵形式，就可以把卡方表达式改一个样子，如下，注意到这里的量都是矩阵

![image-20250621095256008](./sda/img/image-20250621095256008.png)

求解这个玩意的最小值，求导就好，最后解出来如下

![image-20250621100247724](./sda/img/image-20250621100247724.png)
...
![image-20250622155419866](./sda/img/image-20250622155419866.png)



## 9.2 经典置信区间 

![image-20250621144951044](./sda/img/image-20250621144951044.png)

对于这个分布g，我们可以找到一个值，使得观测到theta大于这个值的概率为alpha（图上的ubeta，图画错了，应该叫ualpha），对于概率beta同理，看图

下面的公式也写错上限了，应该是vbeta

![image-20250621145235767](./sda/img/image-20250621145235767.png)

图中没有阴影的部分被称作置信带

![image-20250621145316435](./sda/img/image-20250621145316435.png)

实际上我们经常把u和v弄成反函数的样子

![image-20250621150108980](./sda/img/image-20250621150108980.png)

![image-20250621150120759](./sda/img/image-20250621150120759.png)
...
[a, b]这个区间称为***置信区间***，1 - alpha - beta称为***置信水平***

![image-20250622142759134](./sda/img/image-20250622142759134.png)

![image-20250622143130567](./sda/img/image-20250622143130567.png)
...
![image-20250621155921360](./sda/img/image-20250621155921360.png)

![image-20250621160647430](./sda/img/image-20250621160647430.png)

![image-20250622160530568](./sda/img/image-20250622160530568.png)

> $a(\hat \theta)$是一个从测量值到真值的映射

## 9.4 泊松

![image-20250622163650663](./sda/img/image-20250622163650663.png)

![image-20250622174803948](./sda/img/image-20250622174803948.png)

![image-20250622174824462](./sda/img/image-20250622174824462.png)
